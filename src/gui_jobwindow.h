...
class ReNJobWindow : public RelionJobWindow 
{
public:

	//I/O
	FileNameEntry whole_particles;
	AnyEntry renumber_name;
...
public:
	...
	// Generate the correct commands
	void getCommands(std::string &outputname,
			std::vector<std::string> &commands, std::string &final_command,
			double angpix, double particle_diameter);
};

class SubJobWindow : public RelionJobWindow 
{
public:

	//I/O
	FileNameEntry whole_particles, coordinate_of_particles, reference,mask;	
	SliderEntry pixel_size, binning_factor_of_reference,low_pass_filter;
	BooleanEntry renumber_rawimages, rewindow_micrograph;
	AnyEntry renumber_name;
	//CTF
	BooleanEntry invert_contrast_of_references, invert_micrographs, ctf, ctf_intact_first_peak; 
	//Subtract micrograph or neighbor
	BooleanEntry subtract_reference, output_subtracted, output_projection, subtract_neighbor;
	SliderEntry pre_extraction;

 	//Extract particles
        BooleanEntry extract,norm;
        AnyEntry extract_name;
        SliderEntry new_particle_diameter, extract_size,white_dust,black_dust, target_x, target_y,target_z;

	Fl_Group *subtract_reference_group, *subtract_neighbor_group,*subtract_neighbor_group2, *target_xyz_group, *coordinate_group;
...
class SupJobWindow : public RelionJobWindow 
{
public:

	//I/O
	FileNameEntry whole_particles, coordinate_of_particles, reference, mask, subtracting_particles;	
	SliderEntry pixel_size, binning_factor_of_reference, low_pass_filter;
	BooleanEntry renumber_rawimages;
	AnyEntry renumber_name;
	//CTF
	BooleanEntry invert_contrast_of_references, ctf, ctf_intact_first_peak; 
	//SliderEntry new_particle_diameter, white_dust, black_dust;

	//Subtract micrograph or neighbor
	BooleanEntry subtract_reference, output_particles, output_sub_particles, norm;
	AnyEntry extract_name;
	SliderEntry pre_extraction, extract_size, new_particle_diameter;
        SliderEntry  white_dust,black_dust, target_x, target_y,target_z;
	Fl_Group *target_xyz_group, *coordinate_group;
...
//	FileNameEntry input_star;
//	SliderEntry bin_factor, new_particle_diameter, new_particle_diameter1, rewindow_size, rewindow_size1;
//	BooleanEntry outputrefsubptcls, rewindowrawptcls, rewindowrefsub;
//	AnyEntry refsubptcls, rewinedptcls;
//	Fl_Group *refsub_group, *rewined_group, *rewindowrefsub_group;
...
//	BooleanEntry invert;
//	Fl_Group *ctf_group;
//	BooleanEntry do_ctf, do_ignore_first_ctfpeak;
//
//	//Fitting:
///	BooleanEntry norm;
//	SliderEntry white_dust, black_dust;
//
//	//Target:
//	BooleanEntry shift_in_fourier;
//	SliderEntry target_x, target_y, target_z;
